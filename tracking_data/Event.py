...
class Event:
    ...
    def __init__(self, event):
        event_for_moment = event['eventId']
        moments = event['moments']
        self.moments = [Moment(moment,event_for_moment) for moment in moments]
    ...
    def show(self):
        ...
        if self.moments:
            ...
            #plt.show()
            # Instead of plt.show(), use plt.pause() for the desired duration
            plt.pause(0.1)  # Display the animation for 0.1 seconds
            # Stop the animation
