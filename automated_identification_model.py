...
with open('true_nums.txt', 'r') as file:
    # Iterate through each line in the file
    for line in file:
        true_labels.extend(line.strip())
#print("event_true_labels: ", true_labels)
...
for eventid, group in grouped_data:
    ...
    #print("defending_players: ", defending_players)
    #print("attacking_players: ", attacking_players)

    # Split group into windows
    windows_group = split_into_windows(group)
    #print("windows: ",windows_group)
    ...
    for window_num, window_data in enumerate(windows_group):
        ...
        for timestep, distances_by_timestep in enumerate(distances):
            ...
            #print("timestep: ", timestep, "and distances_by_timestep: ", distances_by_timestep)
            ...
            for attacker_id, attacker in enumerate(attacking_players):
                ...
                for defender_id, defender in enumerate(defending_players):
                    #print("defender_id: ", defender_id, "defender: ", defender)
                    #print("attacker_id: ", attacker_id, "attacker: ", attacker)
                    distance_to_attacker = distances_by_timestep[defender_id][attacker_id]
                    #print(defender,"distance_to_attacker: ",attacker," is: ",distance_to_attacker)
                    ...
                    #print("attacker_probabilities: ", attacker_probabilities)
            ...
            #print("assigned_defenders: ", assigned_defenders)
                    ...
                    if average_player_distance > min_distance_threshold and average_player_distance < max_distance_threshold:
                        ...
                        for attacker, defender in assigned_defenders.items():
                            if prev_assignments.get(attacker) != defender:
                                ...
                                #print("ball_distance_from_attacker: ", ball_distance_from_attacker)
            ...
            #if window_label==2:
            #    windows10_label = 2
            #    print("found two on event: ", eventid,"and timestep: ", event_timestep + 1 ,"all timestep: ", all_timesteps)
